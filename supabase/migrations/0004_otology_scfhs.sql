...
insert into public.exam_questions (station, question_id, ord, prompt, max_marks, model_answers, images) values
  ...
  ('Otology', 'O1', 1, '[History] Based on the case stem, what are the key symptoms you would ask about to confirm your suspicion of a cholesteatoma?', 5,
    '["Foul-smelling, painless, persistent otorrhea — highly characteristic of cholesteatoma (1 mark)", "Progression of hearing loss and presence of tinnitus (1 mark)", "Previous ear surgery, trauma, or grommet insertion (1 mark)", "Laterality and exact duration of symptoms (1 mark)", "(Award 1 mark per point, up to a maximum of 5 marks)"]'::jsonb, '[]'::jsonb),
  ...
  ('Otology', 'O5', 5, '[Examination] What are the classic otoscopic or microscopic findings of an attic (pars flaccida) cholesteatoma?', 5,
    '["Retraction pocket located in the pars flaccida (1 mark)", "Pearly white keratin debris and crusting over the attic (1 mark)", "Erosion of the scutum — the lateral epitympanic wall (1 mark)", "Granulation tissue or an aural polyp originating from the attic (1 mark)", "(Award 1 mark per finding, up to a maximum of 5 marks)"]'::jsonb, '[]'::jsonb),
